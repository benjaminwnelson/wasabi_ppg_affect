...
```{r}
data_long1 <- data3 %>%  
  pivot_longer(cols = c(-SID, -ConditionLabel, -Gender, -Age, -RaceEthnicity), names_sep="_(?=[^_]+$)", names_to = c(".value", "wave"))
```
...
data_long1[,7:9] <- lapply(data_long1[,7:9], as.numeric)
```
...
hr_stress_model1 <- lmer(vasstress ~ 1 + hr_cb + hr_cw + ConditionLabel + Gender + (1 + hr_cw | SID), REML = TRUE, data = data_long2)
...
hr_stress_model2 <- lmer(vasstress ~ 1 + hr_cb*hr_cw + hr_cw*ConditionLabel + hr_cw*Gender + (1 + hr_cw | SID), REML = TRUE, data = data_long2)

hr_stress_model2 <- lmer(vasstress ~ (1 + hr_cw)*(hr_cb + ConditionLabel + Gender) + (1 + hr_cw | SID), REML = TRUE, data = data_long2)
...
hr_stress_model1_compare <- lmer(vasstress ~ 1 + hr_cb + hr_cw + ConditionLabel + Gender + (1 + hr_cw | SID), REML = TRUE, data = data_long2_compare)

#These two models are equivalent
hr_stress_model2_compare <- lmer(vasstress ~ 1 + hr_cb*hr_cw + hr_cw*ConditionLabel + hr_cw*Gender + (1 + hr_cw | SID), REML = TRUE, data = data_long2_compare)
...
hr_anxiety_model1 <- lmer(vasanxiety ~ 1 + hr_cb + hr_cw + ConditionLabel + Gender + (1 + hr_cw | SID), REML = TRUE, data = data_long2, control = lmerControl(optimizer ="Nelder_Mead"))
...
#These two models are equivalent
hr_anxiety_model2 <- lmer(vasanxiety ~ 1 + hr_cw*hr_cb +  hr_cw*ConditionLabel + hr_cw*Gender + (1 + hr_cw | SID), REML = TRUE, data = data_long2)

hr_anxiety_model2 <- lmer(vasanxiety ~ (1 + hr_cw)*(hr_cb +  ConditionLabel + Gender) + (1 + hr_cw | SID), REML = TRUE, data = data_long2)
...
hr_anxiety_model1_compare <- lmer(vasanxiety ~ 1 + hr_cb + hr_cw + ConditionLabel + Gender + (1 + hr_cw | SID), REML = TRUE, data = data_long2_compare, control = lmerControl(optimizer ="Nelder_Mead"))

#These two models are equivalent
hr_anxiety_model2_compare <- lmer(vasanxiety ~ 1 + hr_cb*hr_cw + hr_cw*ConditionLabel + hr_cw*Gender + (1 + hr_cw | SID), REML = TRUE, data = data_long2_compare)
...
#data_long2$gadtotal_win <- DescTools::Winsorize(data_long2$gadtotal, na.rm = TRUE)
#data_long2$bditotal_win <- DescTools::Winsorize(data_long2$bditotal, na.rm = TRUE)
```
...
##HR Predicting Stress
```{r}
hr_stress_model_win <- lmer(vasstress ~ 1 + hr_win_cb + hr_win_cw + ConditionLabel + Gender + (1 + hr_win_cw | SID), REML = TRUE, data = data_long3, control = lmerControl(optimizer ="Nelder_Mead"))
...
##HR Predicting Anxiety
```{r}
hr_anxiety_model_win <- lmer(vasanxiety ~ 1 + hr_win_cb + hr_win_cw +  ConditionLabel + Gender + (1 + hr_win_cw | SID), REML = TRUE, data = data_long3)
